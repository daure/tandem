"""Keep the newest published stable Tandem releases; preserve drafts, prereleases, and tags."""
...
def prune(keep=30, published_tag=None, apply=False):
...
if __name__ == "__main__":
    ...
    try:
        prune(args.keep, args.published_tag, args.apply)
